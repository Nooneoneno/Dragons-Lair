    ...
    return Scaffold(
      ...
      body: _library.isEmpty
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            title: Text(game.name,style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),),
            subtitle: Text(game.releaseDate.toString(),style: TextStyle(color: Colors.white30),),
            trailing: IconButton(
              ...
              onPressed: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('${game.name} removed from your library!')),
                );
              },
            ),
          );
